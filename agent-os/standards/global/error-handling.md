...
- **Protect Sensitive Information**: Never include PII (Personally Identifiable Information) or system-level information in error messages or logs that could enable security leaks
