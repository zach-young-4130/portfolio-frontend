...
- **Visual Workflows**: Use Mermaid syntax for any text-based visual workflows, diagrams, flowcharts, state machines, sequence diagrams, or architectural representations. This ensures consistency, version control compatibility, and easy rendering in markdown files.
