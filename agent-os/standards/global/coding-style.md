...
- **NO RubyDoc**: NEVER add RubyDoc comments (@param, @return, @example) or method/class documentation blocks. See [commenting.md](commenting.md) for details.
...
- **SOLID Principles**: Adhere to SOLID principles (Single Responsibility, Open/Closed, Liskov Substitution, Interface Segregation, Dependency Inversion) when designing classes and modules
